...
@dataclass
class MandelbrotSet:
    """Mandelbrot set class - max iterations is needed to evaluate whether value is member of Mandelbrot set or not. """
    max_iterations: int
...
def denormalize(palette):
    """Convert normalized color value (between 0 and 1) to color value between 0 and 255."""
    return [
...
def make_gradient(colors, interpolation="linear"):
    """Return interpolation function that calculates a color value from input number."""
